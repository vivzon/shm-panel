...
<body class="flex items-center justify-center min-h-screen relative text-slate-200">
    ...
    <div class="fixed inset-0 z-0 pointer-events-none">
        <div class="absolute top-[-10%] left-[-10%] w-[50%] h-[50%] glow-1 blur-3xl rounded-full opacity-60 animate-pulse"></div>
        <div class="absolute bottom-[-10%] right-[-10%] w-[50%] h-[50%] glow-2 blur-3xl rounded-full opacity-60 animate-pulse" style="animation-delay: 2s"></div>
    </div>
    ...
    <div class="w-full max-w-[420px] p-6 relative z-10 perspective-[1000px]">
        <div class="glass-panel p-8 md:p-10 rounded-3xl transform transition-all duration-500 hover:scale-[1.005]">
            ...
            <div class="text-center mb-10">
                <div class="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-blue-600 to-indigo-600 shadow-lg shadow-blue-500/30 mb-6 group transition-transform hover:rotate-6">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-8 h-8 text-white transition-transform group-hover:scale-110" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            ...
            <?php if ($error): ?>
                <div class="mb-8 p-4 rounded-xl bg-red-500/10 border border-red-500/20 text-red-400 text-xs font-bold flex items-center gap-3 animate-[shake_0.5s_ease-in-out]">
            ...
            <form method="POST" class="space-y-6" onsubmit="this.querySelector('button[type=submit]').classList.add('loading')">
                ...
                <div class="input-group">
                    ...
                    <label for="u" class="absolute left-4 top-3.5 text-slate-500 text-sm transition-all duration-200">Username or Email</label>
                </div>

                <div class="input-group">
                    <input id="p" name="p" type="password" required placeholder=" "
                        class="input-field w-full rounded-xl px-4 py-3.5 text-sm text-white outline-none">
                    <label for="p" class="absolute left-4 top-3.5 text-slate-500 text-sm transition-all duration-200">Password</label>
                </div>

                <div class="flex items-center justify-between text-xs">
                    <label class="flex items-center gap-2 cursor-pointer group">
                        <input type="checkbox" class="w-3.5 h-3.5 rounded border-slate-700 bg-slate-800 text-blue-600 focus:ring-offset-0 focus:ring-blue-500/50 transition-colors">
