<aside
    class="w-72 bg-[#060b14] border-r border-[#1e293b] flex flex-col z-20 shadow-2xl h-screen overflow-y-auto custom-scrollbar">
    <div class="p-8 pb-6">
        ...
        <div class="text-[9px] font-bold text-slate-500 uppercase tracking-widest pl-4 mb-3">Core</div>
        <nav class="space-y-1">
        ...
        <div class="text-[9px] font-bold text-slate-500 uppercase tracking-widest pl-4 mb-3 mt-8">Hosting Services</div>
        <nav class="space-y-1">
        ...
        <div class="text-[9px] font-bold text-slate-500 uppercase tracking-widest pl-4 mb-3 mt-8">Tools</div>
        <nav class="space-y-1">
    ...
    <div class="mt-auto p-6 border-t border-[#1e293b] bg-[#020617]/50">
        <a href="logout.php"
