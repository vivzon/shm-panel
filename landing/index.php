...
<head>
    ...
    <style>
        ...
        .hero-gradient {
            background: radial-gradient(circle at top right, #1e40af, #0f172a, #020617);
        }
    </style>
</head>
...
<body class="bg-[#020617] text-white overflow-x-hidden">
    ...
    <section class="relative pt-20 pb-32 px-8 hero-gradient">
        <div class="max-w-7xl mx-auto text-center">
            <div
                class="inline-flex items-center gap-2 px-4 py-2 rounded-full glass text-blue-400 text-xs font-bold tracking-widest uppercase mb-8 border border-blue-500/20">
            ...
            <h1
                class="text-5xl md:text-7xl font-extrabold tracking-tighter mb-6 bg-clip-text text-transparent bg-gradient-to-b from-white to-slate-500">
            ...
            <p class="text-slate-400 text-lg md:text-xl max-w-2xl mx-auto mb-10 leading-relaxed">
                Experience ultra-fast loading speeds, hardened security, and an intuitive management panel built for
    ...
    <section class="px-8 -mt-24 relative z-20">
        <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <a href="<?= $scheme ?>client.<?= $base ?>"
                ...
                <p class="text-slate-400 text-sm leading-relaxed mb-6">Manage your domains, databases, and hosting
            ...
            <a href="<?= $scheme ?>webmail.<?= $base ?>"
                ...
                <p class="text-slate-400 text-sm leading-relaxed mb-6">Access your professional business emails securely
                    from any browser.</p>
            ...
            <a href="<?= $scheme ?>filemanager.<?= $base ?>"
                ...
                <p class="text-slate-400 text-sm leading-relaxed mb-6">Upload and manage your website files with our
                    powerful browser editor.</p>
